      ...
      591: (t, e, n) => {
        ...
        function o() {
          ...
          var g = Object.getPrototypeOf,
            b = g && g(g(A([])));
          b && b !== n && r.call(b, s) && (m = b);
          var w = (y.prototype = f.prototype = Object.create(m));
          function E(t) {
    ...
    (() => {
            ...
            i(e, [
              {
                ...
                value: function (t) {
                  ...
                  t.preventDefault(),
                    ...
                    u(this.menuList, this.events, function () {
      ...
      var E = (function () {
        function e(n) {
          t(this, e),
            ...
            (this.checkDistance = w(this.checkDistance.bind(this), 50));
        }
        return (
          i(e, [
            {
      ...
      var M = (function () {
        ...
        A = (function (e) {
          ...
          function a(e, n) {
            var i;
            return t(this, a), (i = r.call(this, e, n)).bindControlEvents(), i;
          }
          return (
            i(a, [
              {
      ...
      new o('[data-menu="suave"] a[href^="#"]').init(),
        new r('[data-anime="accordion"] dt').init(),
        new a('[data-tab="menu"] li', '[data-tab="content"] section').init(),
        new s(
          '[data-modal="abrir"]',
          '[data-modal="fechar"]',
          '[data-modal="container"]',
        ).init(),
        new c('[data-tooltip]').init(),
        new E('[data-anime="scroll"]').init(),
        new l('[data-dropdown]').init(),
        new h('[data-menu="button"]', '[data-menu="list"]').init(),
      ...
      var C = new A('.slide', '.slide-wrapper');
      C.init(), C.addControl('.custom-controls');
    })();
})();
